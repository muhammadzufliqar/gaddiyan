...

{
...

	{
...

		{
			...
			$site_title = get_settings('site_settings','site_title','Autocon');
			...
			$fb_app_id = get_settings('autocon_settings','fb_app_id','');
...

{
...

    {
        ...
        $currency_placing = get_settings('autocon_settings','currency_placing','before_with_no_gap');
