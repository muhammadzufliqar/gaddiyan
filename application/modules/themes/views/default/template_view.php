					...
					<div>
						...
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							...
							<a href="detail.html">
								...
								<img src="<?php echo theme_url();?>/assets/media/100x80/audiRev.jpg" alt="mers" />
					...
					<div>
						...
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							...
							<a href="detail.html">
								...
								<img src="<?php echo theme_url();?>/assets/media/370x200/mazda.jpg" alt="mazda" />
					...
					<div>
						...
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							...
							<a href="detail.html">
								...
								<img src="<?php echo theme_url();?>/assets/media/186x113/aston.jpg" alt="aston" />
					...
					<div>
						...
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							...
							<a href="detail.html">
								...
								<img src="<?php echo theme_url();?>/assets/media/186x113/jaguar.jpg" alt="jaguar" />
					...
					<div>
						...
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							...
							<a href="detail.html">
								...
								<img src="<?php echo theme_url();?>/assets/media/186x113/mers.jpg" alt="mers" />
					...
					<div>
						...
						<div class="b-featured__item wow rotateIn" data-wow-delay="0.3s" data-wow-offset="150">
							...
							<a href="detail.html">
								...
								<img src="<?php echo theme_url();?>/assets/media/186x113/audi.jpg" alt="audi" />
					 ...
					 <div class="icon_bar text-center">
						...
						<ul class="list-inline">
							...
							<li class="brands wow zoomInUp" data-wow-delay="0.4s">
								...
								<a href="city-cars.html">

									<span>Islamabad<br><span class="totals">(50)</span></span>

								</a>

							</li>

							<li class="brands wow zoomInUp" data-wow-delay="0.2s">

								<a href="city-cars.html">

									<span>Lahore<br><span class="totals">(150)</span></span>
							...
							<li class="brands wow zoomInUp" data-wow-delay="0.4s">
								...
								<a href="city-cars.html">
									...
									<span>Rawalpindi<br><span class="totals">(120)</span></span>
							...
							<li class="brands wow zoomInUp" data-wow-delay="0.4s">
								...
								<a href="city-cars.html">
									...
									<span>Peshawar<br><span class="totals">(125)</span></span>
							...
							<li class="brands wow zoomInUp" data-wow-delay="0.2s">
								...
								<a href="city-cars.html">
									...
									<span>Sialkot<br><span class="totals">(250)</span></span>
							...
							<li class="brands wow zoomInUp" data-wow-delay="0.4s">
								...
								<a href="city-cars.html">
									...
									<span>Sahiwal<br><span class="totals">(110)</span></span>

								</a>

							</li>

							<li class="brands wow zoomInUp" data-wow-delay="0.5s">

								<a href="city-cars.html">

									<span>Faisalabad<br><span class="totals">(1250)</span></span>
						...
						<li class="brands wow zoomInUp" data-wow-delay="0.4s">
								...
								<a href="city-cars.html">
									...
									<span>Gujranwala<br><span class="totals">(750)</span></span>

								</a>

							</li>

						<li class="brands wow zoomInDown" data-wow-delay="0.5s">

								<a href="city-cars.html">

									<span>Quetta<br><span class="totals">(155)</span></span>

								</a>

							</li>

						<li class="brands wow zoomInDown" data-wow-delay="0.4s">

								<a href="city-cars.html">

									<span>Sindh<br><span class="totals">(1250)</span></span>
						...
						<li class="brands wow zoomInDown" data-wow-delay="0.5s">
								...
								<a href="city-cars.html">
									...
									<span>Murree<br><span class="totals">(1250)</span></span>
						...
						<li class="brands wow zoomInDown" data-wow-delay="0.4s">
								...
								<a href="city-cars.html">
									...
									<span>Gujraat<br><span class="totals">(1250)</span></span>

								</a>

							</li>

						<li class="brands wow zoomInDown" data-wow-delay="0.6s">

								<a href="city-cars.html">

									<span>Hyderabad<br><span class="totals">(1250)</span></span>
						...
						<li class="brands wow zoomInDown" data-wow-delay="0.4s">
								...
								<a href="city-cars.html">
									...
									<span>Sargodha<br><span class="totals">(1250)</span></span>
						...
						<li class="brands wow zoomInDown" data-wow-delay="0.6s">
								...
								<a href="city-cars.html">
									...
									<span>Wah cantt<br><span class="totals">(1250)</span></span>

								</a>

							</li>

						<li class="brands wow zoomInLeft" data-wow-delay="0.4s">

								<a href="city-cars.html">

									<span>Islamabad<br><span class="totals">(1250)</span></span>

								</a>

							</li>

						<li class="brands wow zoomInLeft" data-wow-delay="0.6s">

								<a href="city-cars.html">

									<span>Abbotabad<br><span class="totals">(1250)</span></span>
						...
						<li class="brands wow zoomInRight" data-wow-delay="0.6s">

								<a href="city-cars.html">

									<span>Karachi<br><span class="totals">(1250)</span></span>

								</a>

							</li>

						<li class="brands wow zoomInRight" data-wow-delay="0.2s">
				...
				<div class="row">
					...
					<div class="col-sm-4 col-xs-12">
						...
						<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
							...
							<img class="img-responsive" src="<?php echo theme_url();?>/assets/media/370x200/wolks.jpg" alt="wolks" />
					...
					<div class="col-sm-4 col-xs-12">
						...
						<div class="b-world__item wow zoomInUp" data-wow-delay="0.3s" data-wow-offset="100">
							...
							<img class="img-responsive"  src="<?php echo theme_url();?>/assets/media/370x200/mazda.jpg" alt="mazda" />
					...
					<div class="col-sm-4 col-xs-12">
						...
						<div class="b-world__item j-item wow zoomInRight" data-wow-delay="0.3s" data-wow-offset="100">
							...
							<img class="img-responsive"  src="<?php echo theme_url();?>/assets/media/370x200/chevrolet.jpg" alt="chevrolet" />
							...
							<h2>Advantages of Buy New or Used Car</h2>
							...
							<div class="row m-margin" id="first">
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									...
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										...
										<img class="img-responsive"  src="<?php echo theme_url();?>/assets/media/270x150/acura.jpg" alt="mazda" />
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									...
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										...
										<img class="img-responsive"  src="<?php echo theme_url();?>/assets/media/270x150/nissan.jpg" alt="mazda" />
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									...
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										...
										<img class="img-responsive"  src="<?php echo theme_url();?>/assets/media/270x150/acura2016.jpg" alt="mazda" />
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									...
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										...
										<img class="img-responsive"  src="<?php echo theme_url();?>/assets/media/270x150/amg.jpg" alt="mazda" />
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									...
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										...
										<img class="img-responsive"  src="<?php echo theme_url();?>/assets/media/270x150/brabus.jpg" alt="mazda" />
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									...
									<div class="b-auto__main-item wow slideInUp" data-wow-delay="0.3s" data-wow-offset="100">
										...
										<img class="img-responsive"  src="<?php echo theme_url();?>/assets/media/270x150/range.jpg" alt="mazda" />
					...
					<div class="col-md-3 col-xs-6">
						...
						<div class="b-info__latest">
							...
							<div class="b-info__latest-article wow zoomInUp" data-wow-delay="0.3s">
								...
								<div class="b-info__latest-article-photo m-audi"><img src="<?php echo theme_url();?>/assets/media/80x65/audiF.jpg" alt="audiF"></div>
