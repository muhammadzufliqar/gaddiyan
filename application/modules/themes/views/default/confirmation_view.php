...
<div class="row">
    <div class="col-md-12" style="min-height:300px">
        ...
        <img alt="Go T Paypal" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
        </form>
        <?php }?>
        </p>
        ...
        <?php echo get_settings('autocon_settings','signup_payment_bank_instruction','');?>                
        <?php }?>
    </div>    
</div> <!-- /row -->
