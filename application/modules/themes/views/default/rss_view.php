...
<rss version="2.0"
    ...
    <?php foreach($posts->result() as $post): ?>
     	<?php 
     	$car_title =  get_title_for_edit_by_id_lang($post->id,$curr_lang);
     	$description = get_description_for_edit_by_id_lang($post->id,$curr_lang);
     	$detail_link = site_url('show/detail/'.$post->unique_id.'/'.dbc_url_title($car_title));
     	?>
        <item>
          ...
          <guid><?php echo $detail_link; ?></guid>
            ...
            <pubDate><?php echo $post->publish_time; ?></pubDate>
        </item>
