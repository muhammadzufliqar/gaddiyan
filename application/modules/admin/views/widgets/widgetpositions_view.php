...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i>Widget Position</h3>
                <div class="box-tool">
            ...
            <div class="box-content">
                <form action="<?php echo site_url('admin/widgets/widgetpositions')?>" method="post">
                    <div class="form-group">
                        <label class="col-sm-2 col-lg-1 control-label">Widget Position:</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-lg-5 controls">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-check"></i> Show</button>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </form>
...
<div class="row">
    <div class="col-md-6">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i>Available Widgets</h3>
                <div class="box-tool">
                    <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
                    ...
                    <?php foreach($widgets->result() as $row){?>
                        <?php if(isset($active_widgets_array[$row->alias])==FALSE){?>
                            <li class="thumbnail" style="margin-bottom:10px;cursor: move;height:41px;">
                                ...
                                <a href="<?php echo site_url('admin/widgets/edit/'.$row->alias);?>" style="float:right;" class="edit-widget btn btn-info">Edit</a>
                            </li>
                        <?php }?>
                    <?php }?>
                </ol>
    ...
    <div class="col-md-6">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i>Active Widgets</h3>
                <div class="box-tool">
                    <a href="#" data-action="collapse"><i class="fa fa-chevron-up"></i></a>
                            ...
                            foreach ($active_widgets as $widget) 
                            {
                                ...
                                else
                                {
                                    ...
                                    <li class="thumbnail" style="margin-bottom:10px;cursor: move;height:41px;">
                                        ...
                                        <div style="float:left;padding:5px;"><?php echo $row->name;?></div>
                                        <a href="<?php echo site_url('admin/widgets/edit/'.$widget);?>" style="float:right;" class="edit-widget btn btn-info">Edit</a>
                                    </li>
                                <?php
                                }
                            }
