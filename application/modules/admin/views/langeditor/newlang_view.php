				...
				<form action="<?php echo site_url('admin/system/savelang');?>" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-2 col-lg-3 controls">
							<input type="text" name="lang" value="<?php echo set_value('lang');?>" placeholder="Type somethin" class="form-control" >
					...
					<div class="form-group">
						...
						<div class="col-sm-2 col-lg-3 controls">
							<input type="text" name="short_name" value="<?php echo set_value('short_name');?>" placeholder="Type somethin" class="form-control" >
							<span class="help-inline">&nbsp;</span>
