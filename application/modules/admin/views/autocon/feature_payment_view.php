    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                ...
                <p>You'll have to pay <?php echo get_settings('autocon_settings','feature_charge','0').' '.get_settings('paypalsettings','currency','USD');?> and your property will be
                    Featured for <?php echo get_settings('autocon_settings','feature_day_limit','0');?> days</p>
                 <?php if(get_settings('autocon_settings','enable_paypal_transfer','Yes')=='Yes'){?>
                <?php
                ...
                <input type="hidden" name="amount" value="<?php echo get_settings('autocon_settings','feature_charge','0');?>">
                <input type="hidden" name="currency_code" value="<?php echo get_settings('paypal_settings','currency','USD');?>">
                <input type="hidden" name="no_note" value="1">
                <input type="hidden" name="no_shipping" value="1">
                <input type="hidden" name="rm" value="1">
                <input type="hidden" name="return" value="<?php echo site_url('admin/autocon/finish_url');?>">
                <input type="hidden" name="cancel_return" value="<?php echo site_url('admin/autocon/cancel_url');?>">
                ...
                <?php echo get_settings('autocon_settings','featured_payment_bank_instruction','');?>                
                <?php }?>
            </div>
        </div>
    </div>
