            ...
            ?>
					...
					<div class="tabbable">
						...
						<ul class="nav nav-tabs" id="myTab1">
							...
							<li class="<?php echo (default_lang()==$lang->short_name)?'active':'';?>"><a data-toggle="tab" href="#<?php echo $lang->short_name;?>"><i class="fa fa-home"></i> <?php echo $lang->short_name;?></a>
							</li>
							...
							<div id="<?php echo $lang->short_name;?>" class="tab-pane fade in <?php echo (default_lang()==$lang->short_name)?'active':'';?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-7 col-lg-7 controls">
										...
										<textarea style="min-height:200px" class="form-control wysihtml5" name="description<?php echo $lang->short_name;?>">
											<?php echo(set_value('description'.$lang->short_name)!='')?set_value('description'.$lang->short_name):'';?>
										</textarea>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
													...
													<label class="col-md-4 col-sm-4 control-label">
														<?php echo lang_key('condition');?> :</label>
													...
													<div class="col-md-8 col-sm-8 controls">
													  ...
													  ?>
															...
															<option value="<?php echo $status['title'];?>" <?php echo $sel;?>>
																<?php echo lang_key($status['title']);?>
															</option>
						...
						<div class="form-group">
						  ...
						  foreach ($brands->result() as $brand) {
                              ...
                              ?>
									...
									<option value="<?php echo $brand->id;?>" <?php echo $sel;?>>
										<?php echo $brand->name;?>
									</option>
						...
						<div class="form-group">
							...
							<div class="col-md-8 col-sm-8 controls">
                              ...
                              ?>
									...
									<option value="<?php echo $option['title'];?>" <?php echo $sel;?>>
										<?php echo lang_key($option['title']);?>
									</option>
							...
							<div class="col-md-8 col-sm-8 controls">
								...
								<div class="input-group">
									...
									<span class="input-group-addon">
										<?php echo $this->session->userdata('system_currency'); ?>
									</span>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('mileage');?> :</label>
							...
							<div class="col-md-8 col-sm-8 controls">
								...
								<div class="input-group">
									...
									<span class="input-group-addon" style="border-radius: 0 5px 5px 0;">
										<?php echo get_settings('autocon_settings','mileage_unit','miles'); ?>
									</span>
                          ...
                          $agents = $CI->show_model->get_users_by_range('all','','first_name');?>
								...
								<select name="created_by" class="form-control input-sm">
                                  ...
                                  ?>
									...
									<option value="<?php echo $agent->id;?>" <?php echo $sel;?>>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('Drive Train');?> :</label>
							...
							<div class="col-md-8 col-sm-8 controls">
								...
								<input type="text" name="drive_train" value="<?php echo(set_value('drive_train')!='')?set_value('drive_train'):'';?>" placeholder="Drive Train" class="form-control input-sm">
						...
						<div class="form-group">
							...
							<div class="col-md-8 col-sm-8 controls">
                              ...
                              ?>
									...
									<option value="<?php echo $model->id;?>" <?php echo $sel;?>>
										<?php echo $model->name;?>
									</option>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('transmission');?> :</label>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('Location');?> :</label>
						...
						<input type="text" name="expired_date" value="<?php echo(set_value('expired_date')!='')?set_value('expired_date'):'';?>" placeholder="Expired Date" class="form-control input-sm" id="datepicker">
				...
				<div class="box-content">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('reg_no');?> :</label>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('engine_size');?> :</label>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('fuel_type');?> :</label>
                           ...
                           "Octane", "Others");?>
                               ...
                               ?>
									...
									<option value="<?php echo $option;?>" <?php echo $sel;?>>
										<?php echo lang_key($option);?>
									</option>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('interior_color');?> :</label>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('City Fuel Economy');?> :</label>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('safety_rating');?> :</label>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('engine_type');?> :</label>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('steering_type');?> :</label>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('exterior_color');?> :</label>
						...
						<div class="form-group">
							...
							<label class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('Hwy Fuel Economy');?> :</label>
				...
				<div class="box-content">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<label id="sales-label" class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('height');?> :</label>
						...
						<div class="form-group">
							...
							<label id="sales-label" class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('track_rear');?> :</label>
						...
						<div class="form-group">
							...
							<label id="sales-label" class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('length');?> :</label>
						...
						<div class="form-group">
							...
							<label id="sales-label" class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('ground_clearance');?> :</label>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<label id="sales-label" class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('track_front');?> :</label>
						...
						<div class="form-group">
							...
							<label id="sales-label" class="col-md-4 col-sm-4 control-label">
								<?php echo lang_key('wheelbase');?> :</label>
                  ...
                  ?>
					...
					<div class="form-group">
						...
						<label class="col-sm-3 col-lg-2 control-label">
							<?php echo lang_key($field['title']); ?>:</label>
					...
					<div class="form-group">
						...
						<div class="col-sm-6 col-lg-6 controls">
							...
							<textarea name="<?php echo $field['name'];?>" class="form-control">
								<?php echo set_value($field['name']);?>
							</textarea>
