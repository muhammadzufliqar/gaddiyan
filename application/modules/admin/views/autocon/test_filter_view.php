...
<h4>Status</h4>
<div style="display: block;">
    <input type="checkbox" value="condition_new" name="status[]" id="status_" class="board-filter-checkbox">
    <label>New</label>

    <div class="clearfix"></div>
    <input type="checkbox" value="condition_available" name="status[]" id="status_" class="board-filter-checkbox">
    <label>Available</label>

    <div class="clearfix"></div>
    <input type="checkbox" value="condition_sold" name="status[]" id="status_" class="board-filter-checkbox">
    <label>Sold</label>
