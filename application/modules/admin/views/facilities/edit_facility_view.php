  ...
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-content">
      		...
      		<form class="form-horizontal" id="addcategory" action="<?php echo site_url('admin/autocon/update_facility');?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-lg-5 controls">
                        ...
                        <iframe src="<?php echo site_url('admin/autocon/iconuploader');?>" style="border:0;margin:0;padding:0;height:130px;"></iframe>
                    </div>
                </div>
