<div class="row">	
  <div class="col-md-12">
    ...
    <div class="box">
      <div class="box-title">
        <h3><i class="fa fa-bars"></i>New Category</h3>
        <div class="box-tool">
      		...
      		<form class="form-horizontal" id="addcategory" action="<?php echo site_url('admin/category/addcategory');?>" method="post">
				<div class="form-group">
					...
					<div class="col-sm-4 col-lg-5 controls">
						<input type="text" name="title" value="<?php echo(set_value('title')!='')?set_value('title'):'';?>" placeholder="Type somethin" class="form-control input-sm" >
						<span class="help-inline">&nbsp;</span>
						<?php echo form_error('title'); ?>
					</div>
				</div>			
				<div class="form-group">
					<label class="col-sm-2 col-lg-1 control-label">Parent:</label>
					<div class="col-sm-4 col-lg-5 controls">
