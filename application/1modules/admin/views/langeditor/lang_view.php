	...
	<div class="col-md-12">
		...
		<div class="box">
			...
			<div class="box-content">
				...
				<a id="export_file" href="<?php echo site_url('admin/system/exportlangfile/'.$row->id);?>" class="btn btn-info">Export to file</a>

				<a id="import_file" href="<?php echo site_url('admin/system/importlangfile/'.$row->id);?>" class="btn btn-warning">Import from file</a>
