<div class="row">
	<div class="col-md-12">
		<div class="box">
			<div class="box-title">
				<h3><i class="fa fa-bars"></i> Select language</h3>
				<div class="box-tool">
			...
			<div class="box-content">
				...
				<a id="sel_lang_form" href="<?php echo site_url('admin/system/editlang/'.$row->id);?>" class="btn btn-primary">Edit</a>
				<a id="edit_as_new_lang" href="<?php echo site_url('admin/system/editasnewlang/'.$row->id);?>" class="btn btn-info">Edit As New</a>
				<a id="delete_lang" href="<?php echo site_url('admin/system/deletelang/'.$row->id);?>" class="btn btn-danger">Delete</a>
			</div>
		</div>
	</div>
</div>	
			...
			<div class="box-content">
				...
				<form action="<?php echo site_url('admin/system/savelang');?>" method="post">
					...
					<div class="form-group">
						<label class="col-sm-1 col-lg-1 control-label">Language</label>
						<div class="col-sm-2 col-lg-3 controls">
							<input type="text" name="lang" value="<?php echo (isset($row->lang))?$row->lang:set_value('lang');?>" placeholder="Type somethin" class="form-control" >
					...
					<div class="form-group">
						<label class="col-sm-1 col-lg-1 control-label">Short name</label>
						<div class="col-sm-2 col-lg-3 controls">
							<input type="text" name="short_name" value="<?php echo (isset($row->short_name))?$row->short_name:set_value('short_name');?>" placeholder="Type somethin" class="form-control" >
							<span class="help-inline">&nbsp;</span>
					...
					<a href="javascript:void(0);" class="addanother btn btn-info" style="margin-left:25px;margin-bottom:5px;">Add another</a><br/>
