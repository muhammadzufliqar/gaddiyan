...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <a href="<?php echo site_url('admin/autocon/newbrandmodel/brand');?>" class="btn btn-success add-brandmodel">Add brand</a>
    <a href="<?php echo site_url('admin/autocon/newbrandmodel/model');?>" class="btn btn-info add-brandmodel">Add model</a>
                  ...
                  <td data-title="Action" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/autocon/editbrandmodel/'.$row->type.'/'.$row->id);?>" class="edit-brandmodel">Edit</a></li>
                          <li><a href="<?php echo site_url('admin/autocon/deletebrandmodel/'.$curr_page.'/'.$row->id);?>">Delete</a></li>
