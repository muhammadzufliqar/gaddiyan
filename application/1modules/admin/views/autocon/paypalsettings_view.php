    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/autocon/savepaypalsettings/');?>" method="post">
                    ...
                    <div class="form-group" id="item_name">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="item_name" value="<?php echo(isset($settings->item_name))?$settings->item_name:'';?>" placeholder="Type somethin" class="form-control" >
                    ...
                    <div class="form-group" id="email">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="email" value="<?php echo(isset($settings->email))?$settings->email:'';?>" placeholder="Type somethin" class="form-control" >
                    ...
                    <div class="form-group" id="finish_url">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="finish_url" value="<?php echo(isset($settings->finish_url))?$settings->finish_url:'';?>" placeholder="Type somethin" class="form-control" >
                    ...
                    <div class="form-group" id="cancel_url">
                        ...
                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="cancel_url" value="<?php echo(isset($settings->cancel_url))?$settings->cancel_url:'';?>" placeholder="Type somethin" class="form-control" >
