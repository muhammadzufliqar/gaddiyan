    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-title">
                ...
                <h3><i class="fa fa-bars"></i> <?php echo lang_key('all_email_to_dealer'); ?></h3>
            ...
            <div class="box-content">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php $i=$start+1;foreach($posts->result() as $row):
                                ...
                                <tr>
                                    ...
                                    <td data-title="<?php echo lang_key('date');?>" class="numeric"><?php echo date('m-d-Y',str_replace('query_email#','',$row->key));?></td>
                                    ...
                                    <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-info">
                                                ...
                                                <li><a class="detail" id="<?php echo $row->id;?>" href="<?php echo site_url('admin/autocon/editcar/'.$curr_page.'/'.$row->id);?>">Detail</a></li>
                                                <?php if(is_admin()){?>
                                                <?php }?>
                                            </ul>
                ...
                <a href="<?php echo site_url('admin/autocon/bulkemailform');?>" class="btn btn-success bulk-email">Send Bulk Email</a>
            </div>
