  ...
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-title">
        ...
        <h3><i class="fa fa-bars"></i> Edit page</h3>
      ...
      <div class="box-content">
		...
		<?php if(isset($page->editable) && $page->editable==1){?>
		...
		<div class="form-group">
			...
			<label class="col-sm2 col-lg-2 control-label">Menu Title</label>
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">Menu alias</label>

			<div class="col-sm-2 col-lg-3 controls">

				<input type="text" class="form-control" name="alias" id="alias" value="<?php echo $alias;?>" placeholder="Type somethin" />
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">Show in menu</label>
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">Page layout</label>
		...
		<div class="form-group">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">Content from</label>

			<div class="col-sm-2 col-lg-3 controls">

				<select name="content_from" id="content_from" class="form-control" <?php echo (isset($page->editable) && $page->editable==0)?'':'';?>>
		...
		<div class="form-group url">
			...
			<label class="col-sm-2 col-md-2 col-lg-2 control-label">Url</label>

			<div class="col-sm-5 col-lg-6 controls">

				<input type="text" class="form-control" name="url" value="<?php echo $url;?>" placeholder="Type somethin" <?php echo (isset($page->editable) && $page->editable==0)?'readonly="readonly"':'';?> />
    ...
    <div class="box">
      ...
      <div class="box-title">
        ...
        <h3><i class="fa fa-bars"></i> Seo Options</h3>
      ...
      <div class="box-content">
	      	...
	      	<div class="form-group">
				...
				<label class="col-sm-2 col-md-2 col-lg-2 control-label">Meta desc:</label>
			...
			<div class="form-group">
				...
				<label class="col-sm-2 col-md-2 col-lg-2 control-label">Key words:</label>
			...
			<div class="form-group">
				...
				<label class="col-sm-2 col-md-2 col-lg-2 control-label">Crawl after(days):</label>
