    ...
    <div class="box">
      ...
      <div class="box-content">
		...
		<div class="form-group">
			<label class="col-sm-1 col-lg-1 control-label">Menu Title</label>
			<div class="col-sm-2 col-lg-3 controls">
				<input type="text" class="form-control" name="title" value="<?php echo $title;?>" placeholder="Type somethin" />
		...
		?>
		<div class="form-group">
			<label class="col-sm-1 col-lg-1 control-label">Page layout</label>
			<div class="col-sm-2 col-lg-3 controls">
