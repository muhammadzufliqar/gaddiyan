    ...
    <div class="box">
      ...
      <div class="box-content">
		...
		<div class="form-group">
			...
			<label class="col-sm12 col-lg-12 control-label">Type</label>
		...
		<div class="form-group">
			...
			<label class="col-sm12 col-lg-12 control-label">Post Title</label>
		...
		<div class="form-group">
			...
			<label class="col-sm-12 col-lg-12 control-label">Content</label>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4 col-lg-5 controls">                    
            	<?php $v = (set_value('featured_img')!='')?set_value('featured_img'):((isset($page) && isset($page->featured_img))?$page->featured_img:'');?>
