<?php
...

	{
...

		{
			...
			$error .= '<div class="alert alert-error">SITE_ROOT/'.$file.' is not writable.Please change it\'s permission before installing autocon[ERROR].</div>';
...

	{
		...
		<p class="lead">Everything seems to be ok. Let's install Autocon with in 2 easy step :-)</p>
