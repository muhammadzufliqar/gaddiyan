...
if($featured_esates->num_rows() <= 0 ){ ?>
    <div class="alert alert-info">No Cars</div>
<?php
} else {
?>
            <div class="widget">

                <h2 class="widget-title"><i class="fa fa-car"></i>&nbsp;<?php echo lang_key('top_cars');?></h2>
                ...
                <div class="thumbnail thumb-shadow widget-listing">
                    ...
                    <div class="caption" style="padding: 2px;">
                        <span class="property-title"><?php echo character_limiter($title,12);?></span>
